...
@Component({
  ...
  styleUrls: ['./manage-order.component.scss', '../../../assets/vendors/styles/style.css', '../../../assets/srctemplate/plugins/datatables/css/dataTables.bootstrap4.min.css','../../../assets/vendors/styles/core.css','../../../assets/vendors/styles/icon-font.min.css']
})
export class ManageOrderComponent implements OnInit {
  ...
  getProductDetails(value: any) {
    this.productService.getById(value.id).subscribe((response: any) => {
      ...
      this.manageOrderForm.controls['total'].setValue(response[0].price * 1);
    }, (error: any) => {
      console.log(error);
      if (error.error?.message) {
        this.responseMessage = error.error?.message;
